...
enum class AppLanguage(
    ...
    companion object {
        fun fromCode(code: String?): AppLanguage =
            when {
                code == null -> DEVICE
                code.equals("zh-CN", ignoreCase = true) ||
                    code.equals("zh-Hans", ignoreCase = true) ||
                    code.equals("zh", ignoreCase = true) -> CHINESE_SIMPLIFIED
                code.equals("zh-TW", ignoreCase = true) ||
                    code.equals("zh-Hant", ignoreCase = true) ||
                    code.equals("zh-HK", ignoreCase = true) -> CHINESE_TRADITIONAL
                else -> entries.firstOrNull { it.code.equals(code, ignoreCase = true) } ?: DEVICE
            }
    }
}
